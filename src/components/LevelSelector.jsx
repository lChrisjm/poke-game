  ...
  return (
    <div className=" flex flex-col justify-center content-center text-center py-8  md:w-screen md:grow">
      <div className=" text-center">
        <img className="mx-auto w-3/4 md:w-1/5 md:h-auto h-auto" src={logoPoke} alt="Pokelogo" />
      </div>
      <div className="py-4">
          ...
          <button
            ...
            className={`${
              mode.id == 1
                ...
                ? "bg-yellow-500"
                : "bg-red-500"
            } px-6 py-4 mx-auto my-2 w-3/4 font-play uppercase font-semibold text-2xl  rounded-md text-white md:w-1/4 md:py-5 md:text-4xl`}
